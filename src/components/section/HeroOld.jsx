        ...
        <div className='bg-secondary text-white hero-image '>
            <div className='container mx-auto flex flex-col lg:flex-row items-center relative min-h-[90vh]'>
                ...
                <div className='w-full lg:w-1/2 text-center lg:text-left z-10'>
                    <div className='border border-red-400  absolute top-0 left-0 w-40 h-40 rounded p-4 animate-wiggle'>
                        <img
                            src={vectorImage}
                            alt=''
                            className=' animate-wiggle z-0'
                        />
                    </div>
                    <p className='text-base tracking-wide font-thin text-primary uppercase  z-10'>
                        Strategies for Success
                    </p>
                    <h2 className='text-[36px] lg:text-[62px] font-bold leading-tight mt-4 z-10'>
                        Go to <br />
                        the Polls
                    </h2>
